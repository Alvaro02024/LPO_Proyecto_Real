...
namespace Sview {
	...
	/// <summary>
	/// Summary for a_mantenimiento_Codigo_editar
	/// </summary>
	public ref class a_mantenimiento_Codigo_editar : public System::Windows::Forms::Form
	{
	public:
		a_mantenimiento_Codigo_editar(void)
		{
			InitializeComponent();
			//
		...
		a_mantenimiento_Codigo_editar(int editCode)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &a_mantenimiento_Codigo_editar::button1_Click);
			// 
			// groupBox1
			// 
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(289, 323);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 0;
			this->button2->Text = L"Cancelar";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &a_mantenimiento_Codigo_editar::button2_Click);
			// 
			// a_mantenimiento_Codigo_editar
			// 
			...
			this->Name = L"a_mantenimiento_Codigo_editar";
			this->Text = L"a_mantenimiento_Codigo_editar";
			this->Load += gcnew System::EventHandler(this, &a_mantenimiento_Codigo_editar::a_mantenimiento_Codigo_editar_Load);
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) { //Botón cancelar
		this->Close();
	}
	private: System::Void a_mantenimiento_Codigo_editar_Load(System::Object^ sender, System::EventArgs^ e) { //Carga
		figuraController^ fgContr = gcnew figuraController();
		figuraCorte^ objFiguraSeleccionada = fgContr->buscar1FiguraxCodigo(editCode);
		
		this->textBox1->Text = Convert::ToString(editCode);
