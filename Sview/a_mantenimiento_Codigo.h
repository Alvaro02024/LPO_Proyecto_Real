#pragma once
#include "a_mantenimiento_Codigo_editar.h"
#include "a_mantenimiento_Codigo_nuevo.h"
...
namespace Sview {
	...
	/// <summary>
	/// Summary for a_mantenimiento_Codigo
	/// </summary>
	public ref class a_mantenimiento_Codigo : public System::Windows::Forms::Form
	{
	public:
		a_mantenimiento_Codigo(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &a_mantenimiento_Codigo::button1_Click);
			// 
			// textBox1
			// 
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(127, 356);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 2;
			this->button2->Text = L"Nuevo";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &a_mantenimiento_Codigo::button2_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(261, 356);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(75, 23);
			this->button3->TabIndex = 3;
			this->button3->Text = L"Editar";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &a_mantenimiento_Codigo::button3_Click);
			// 
			// button4
			// 
			this->button4->Location = System::Drawing::Point(404, 356);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(75, 23);
			this->button4->TabIndex = 4;
			this->button4->Text = L"Eliminar";
			this->button4->UseVisualStyleBackColor = true;
			this->button4->Click += gcnew System::EventHandler(this, &a_mantenimiento_Codigo::button4_Click);
			// 
			// dataGridView1
			// 
			...
			this->Name = L"a_mantenimiento_Codigo";
			this->Text = L"a_mantenimiento_Codigo";
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) { //BOTÓN NUEVO
		a_mantenimiento_Codigo_nuevo^ FCnuevo = gcnew a_mantenimiento_Codigo_nuevo();
		FCnuevo->ShowDialog();
	}

	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) { //BOTÓN EDITAR
		...
		a_mantenimiento_Codigo_editar^ FCeditar = gcnew a_mantenimiento_Codigo_editar(CodigoEditar);
		FCeditar->ShowDialog();
	}

	private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) { //BOTÓN ELIMINAR
		int filaSeleccionada = this->dataGridView1->SelectedRows[0]->Index; /*Le pongo [0] porque deseo el índice de la única fila que he seleccionado*/
