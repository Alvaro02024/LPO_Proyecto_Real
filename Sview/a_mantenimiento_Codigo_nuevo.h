...
namespace Sview {
	...
	/// <summary>
	/// Summary for a_mantenimiento_Codigo_nuevo
	/// </summary>
	public ref class a_mantenimiento_Codigo_nuevo : public System::Windows::Forms::Form
	{
	public:
		a_mantenimiento_Codigo_nuevo(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(25, 49);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(132, 343);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 3;
			this->button1->Text = L"Aceptar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &a_mantenimiento_Codigo_nuevo::button1_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(289, 343);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 3;
			this->button2->Text = L"Cancelar";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &a_mantenimiento_Codigo_nuevo::button2_Click);
			// 
			// a_mantenimiento_Codigo_nuevo
			// 
			...
			this->Name = L"a_mantenimiento_Codigo_nuevo";
			this->Text = L"a_mantenimiento_Codigo_nuevo";
